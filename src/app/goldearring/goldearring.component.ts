...
@Component({
  selector: 'app-goldearring',
  templateUrl: './goldearring.component.html',
  styleUrls: ['./goldearring.component.css']
})
export class GoldearringComponent implements OnInit {
