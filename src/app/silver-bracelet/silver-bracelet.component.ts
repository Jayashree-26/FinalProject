...
@Component({
  selector: 'app-silver-bracelet',
  templateUrl: './silver-bracelet.component.html',
  styleUrls: ['./silver-bracelet.component.css']
})
export class SilverBraceletComponent implements OnInit {
