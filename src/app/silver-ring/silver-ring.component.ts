...
@Component({
  selector: 'app-silver-ring',
  templateUrl: './silver-ring.component.html',
  styleUrls: ['./silver-ring.component.css']
})
export class SilverRingComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.api.silverring().subscribe((res) => {
