...
@Component({
  selector: 'app-diamond-chain',
  templateUrl: './diamond-chain.component.html',
  styleUrls: ['./diamond-chain.component.css']
})
export class DiamondChainComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.api.diamondchain().subscribe((res) => {
