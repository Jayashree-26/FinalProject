...
@Component({
  selector: 'app-silver-earring',
  templateUrl: './silver-earring.component.html',
  styleUrls: ['./silver-earring.component.css']
})
export class SilverEarringComponent implements OnInit {
