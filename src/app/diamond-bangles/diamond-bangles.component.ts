...
@Component({
  selector: 'app-diamond-bangles',
  templateUrl: './diamond-bangles.component.html',
  styleUrls: ['./diamond-bangles.component.css']
})
export class DiamondBanglesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.api.diamondbangles().subscribe((res) => {
