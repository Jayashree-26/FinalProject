...
@Component({
  selector: 'app-silver-bangles',
  templateUrl: './silver-bangles.component.html',
  styleUrls: ['./silver-bangles.component.css']
})
export class SilverBanglesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.api.silverbangles().subscribe((res) => {
