...
@Component({
  selector: 'app-diamond-earring',
  templateUrl: './diamond-earring.component.html',
  styleUrls: ['./diamond-earring.component.css']
})
export class DiamondEarringComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.api.diamondearring().subscribe((res) => {
