...
@Component({
  selector: 'app-diamond-ring',
  templateUrl: './diamond-ring.component.html',
  styleUrls: ['./diamond-ring.component.css']
})
export class DiamondRingComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.api.diamondring().subscribe((res) => {
