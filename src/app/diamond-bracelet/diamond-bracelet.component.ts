...
@Component({
  selector: 'app-diamond-bracelet',
  templateUrl: './diamond-bracelet.component.html',
  styleUrls: ['./diamond-bracelet.component.css'],
})
export class DiamondBraceletComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.api.diamondbracelet().subscribe(
      (res) => {
      ...
      (error) => {
        console.error('Error fetching diamond bracelet data:', error);
